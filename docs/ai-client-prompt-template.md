...
When the task includes address-book initialization, use these exact values:

1. SEPA beneficiary (`John Doe`)
   - `iban`: `FR7616748000014733062059352`
   - `respondingPspBic`: `BUMDFRP2`
   - `label/source`: `FAUCET`
2. Crypto beneficiary (`John Doe`)
   - `address`: `0x1D07bc08F3fdBE0892ef6aC437e4b51c304cCB3B`
   - `chainId`: `421614` (unless the developer explicitly requests another chain)
